    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        @if ($role !== 'admin')    
            ...
            <div x-show="role === 'mahasiswa'" x-cloak>
                ...
                <x-input-error class="mt-2" :messages="$errors->get('nim')" disabled/>
            </div>
            ...
            <div x-show="role === 'dosen'" x-cloak>
                ...
                <x-input-error class="mt-2" :messages="$errors->get('nidn')" disabled/>
            </div>
            ...
            <div x-show="role === 'dosen' || role === 'admin'" x-cloak>
                ...
                <x-input-error class="mt-2" :messages="$errors->get('nip')" disabled/>
            </div>
