@foreach ($users as $user)
    ...
    <tr class="hover:bg-gray-100 dark:hover:bg-gray-800 transition">
        ...
        <x-table-body>
            <span
                class="inline-block px-2 py-0.5 text-xs rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100"
            >
                {{ ucfirst($user->role) }}
            </span>
        </x-table-body>
        <x-table-body>
            <div class="flex gap-4">
                <a
                    href="{{ route('userManagement.edit', $user->id) }}"
